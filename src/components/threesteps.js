		...
		<div className="p-4" ref={ref}>
			...
			<div className="flex flex-col lg:flex-row justify-center text-center">
				...
				>
					...
					<p>
						Use the loan calculator below to know exactly what you'll pay <strong>before</strong> you apply.
						You can borrow as little as $2,000 up to the full tuition{costOfLiving && <span> and cost of living max</span>}{' '}
						for your progam.
					</p>
				</div>
				...
				>
					...
					<p>
						Choose between the Onsite Bootcamp, Online Full-Time Bootcamp, Online Part-Time Bootcamp, and
				...
				>
					...
					<p className="m-0">
						You'll be on your way to an exciting career in tech as part of {schoolName}'s powerful network.
					</p>
					<Button
