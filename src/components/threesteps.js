        ...
        <div className="p-4" ref={ref}>
            ...
            <div className="flex flex-col lg:flex-row justify-center text-center">
                ...
                <div id="stepCard2" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-primary border-t-8">
                    ...
                    <p>Looking for another Thinkful program? Check out: <br/>{' '}
                        <a className="text-primary"  href="https://thinkful-da.skills.fund" target="_blank" rel="noreferrer noopener">Data Analytics Flex</a>,{' '}
                        <a className="text-primary"  href="https://thinkful-ds.skills.fund" target="_blank" rel="noreferrer noopener">Data Science Flex</a>,{' '} 
                        <a className="text-primary"  href="https://thinkful-dsi.skills.fund" target="_blank" rel="noreferrer noopener">Data Science Immersion</a>,{' '} 
                        <a className="text-primary"  href="https://thinkful-ei.skills.fund" target="_blank" rel="noreferrer noopener">Engineering Immersion</a>,{' '}
                        <a className="text-primary"  href="https://thinkful-nw.skills.fund" target="_blank" rel="noreferrer noopener">Engineering Nights & Weekends</a>,{' '}
                        <a className="text-primary"  href="https://thinkful-pdf.skills.fund" target="_blank" rel="noreferrer noopener">Product Design Flex</a>
                    </p>
                </div>
