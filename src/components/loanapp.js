    ...
    >
      ...
      <div className="rounded shadow-2xl pt-8 px-8 mx-4 bg-white w-full md:w-1/2">
        ...
        <h3 className="text-center font-normal">
          ...
          {costOfLiving && <span> and Living Cost</span>} Financing
        </h3>
        ...
        <form
          className={formName}
          onSubmit={
            programName === "Data Science" ? handleNotify : handleSubmit
          }
        >
          ...
          {programName === "Data Science" && !submitted && (
            <p className="text-center">
              Applications for the Data Science program will become available 90
              days before the cohort start date.
            </p>
          )}
          {programName === "Data Science" && submitted && (
            <p className="text-center">
              Thanks for requesting more information! We'll let you know when
              the application button for the Data Science program becomes
              available.
            </p>
          )}
          {!submitted && (
