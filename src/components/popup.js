...
const Popup = props => {
    ...
    return (
        <div className={isPopupVisible ? "popup" : "popup hidePopup"}>
            {!thankYou && <div className="flex flex-col items-center justify-center text-white"><p className="m-0 popup--getReady">Get ready for upcoming start dates at {props.schoolName}! </p><p className="m-0">Plan your funding with Skills Fund. We'll send you a step-by-step guide to paying for your program.</p></div>}
