	...
	<header>
		<div className="flex justify-center shadow-lg">
			<div className="w-full flex justify-around items-center py-2 px-2 lg:px-0">
				...
				>
					<img src={schoolLogo} alt={schoolName} className="h-8 md:h-12" loading="lazy" id="schoolLogo" />
				</a>
				...
				<a
					...
					className="w-1/2 lg:w-1/3 flex justify-center"
				>
					<img src={skillsFund} alt="Skills Fund logo" className="h-6 md:h-8" loading="lazy" id="skfLogo" />
				</a>
			</div>
		</div>
	</header>
